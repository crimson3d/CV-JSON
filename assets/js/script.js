async function fetchData() {
    try {
        ...
        if (cvData?.skills) {
            ...
            if (skillsContainer) {
                let skillsHTML = '<h3 class="section__title">HABILIDADES</h3>';
                ...
                cvData.skills.forEach((skillSet) => {
                    ...
                    skillsHTML += `<div class="section__set">`;
        ...
        if (cvData?.languages) {
            ...
            if (languagesContainer) {
                let languagesHTML = '<h3 class="section__title">IDIOMAS</h3>';

                cvData.languages.forEach((languageSet) => {
                    languagesHTML += `<p class="section__text">${languageSet.language}: ${languageSet.fluency}</p>`;
        ...
        if (cvData?.education) {
            ...
            if (educationContainer) {
                let educationHTML = '<div class="section__top"><div class="top__icon"><img src="./assets/images/education-svgrepo-com.svg" alt="certificates-icon" class="icon" /></div><h3 class="section__title">FORMACIÓN</h3></div>';

                cvData.education.forEach((educationSet) => {
                    educationHTML += `<div class="section__text">
        ...
        if (cvData?.certificates) {
            ...
            if (certificatesContainer) {
                let certificatesHTML = '<div class="section__top"><div class="top__icon"> <img src="./assets/images/star-svgrepo-com.svg" alt="certificates-icon" class="icon" /></div><h3 class="section__title">CERTIFICADOS</h3></div>';
        ...
        if (cvData?.work) {
            ...
            if (workContainer) {
                let workHTML = '<div class="section__top"><div class="top__icon"> <img src="./assets/images/investigation-svgrepo-com.svg" alt="work-icon" class="icon" /></div><h3 class="section__title">EXPERIENCIA LABORAL</h3></div>';
                ...
                cvData.work.forEach((workSet) => {
                    ...
                    <div class="work__card">
                        ...
                        <p class="card__middle">${workSet.name}</p>
                        <p class="card__bottom">${workSet.summary}</p>
                    </div>`;
